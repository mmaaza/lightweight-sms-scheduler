...
var WebhookProvider = /** @class */ (function () {
    function WebhookProvider() {
        var url = process.env.SMS_WEBHOOK_URL;
        if (!url) {
            throw new Error('SMS_WEBHOOK_URL environment variable is required for WebhookProvider');
        }
        this.webhookUrl = url;
    }
    WebhookProvider.prototype.sendSms = function (to, body) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, fetch(this.webhookUrl, {
                                ...
                                headers: {
                                    ...
                                    'Authorization': "Bearer ".concat(process.env.SMS_WEBHOOK_TOKEN || '')
                                },
                    ...
                    case 1:
                        response = _a.sent();
                        if (!response.ok) {
                            console.error("[WebhookProvider] Failed to send SMS. Status: ".concat(response.status));
                            return [2 /*return*/, false];
                        }
                        return [2 /*return*/, true];
                    case 2:
                        error_1 = _a.sent();
                        console.error("[WebhookProvider] Error sending SMS:", error_1);
                        return [2 /*return*/, false];
